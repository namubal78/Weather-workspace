...
<body>
    ...
    <div style="color: lightgray; margin: 10px; font-size: 20px;" >
        현재 날씨&nbsp;<i class="fa-solid fa-location-crosshairs" style="color: darkgray;"></i></div>
    ...
    <div style="color: lightgray; margin: 10px; font-size: 20px;">1일 최저 기온은 'C, 최고 기온은 'C 입니다.</div>
